 ...
 * @author Rosary
 */
public class CMySqlActividad extends CRUD implements IActividad{
    ...
    /**
     * Lista todas las actividad 
     * @return matriz tipo string de todos sus campos y lista de items combo
     */
    @Override
    public Resultado listar(){
        String sql = "select idActividad, nombre, organizador, lugar, fecha, valor, totalTarjetas "
